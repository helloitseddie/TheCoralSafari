...
class MapAPI: ObservableObject{
    ...
    init(){
        self.region = MKCoordinateRegion(center: CLLocationCoordinate2D(latitude: 51.5, longitude: -0.1275), span: MKCoordinateSpan(latitudeDelta: 5, longitudeDelta: 5))
        self.locations.insert(Location(name: "pin", coordinate: CLLocationCoordinate2D(latitude: 51.5, longitude: -0.1275)), at: 0)
    }
